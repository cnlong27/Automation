...
$Handle = ""
Local $posLevel1[3][2] = [[800, 570], [990,565], [990,620]]
Local $posLevel2[3][2] = [[800, 570], [990,620], [990,565]]
Local $posLevel3[3][2] = [[800, 570], [990,565], [990,620]]
...
#Region run function
	...
	Func switchClickStart()
		For $i = 1 To UBound($simulatorList) - 1
			WinActivate($simulatorList[$i][1]) ; Activate a window
			_findImageBtn("start", 120, 1000)
			Sleep(2000) ; Wait 2 seconds
			PlayTutorialFirst()
		Next
	...
	Func switchFindDataOrCreateID()
		For $i = 1 To UBound($simulatorList) - 1
			WinActivate($simulatorList[$i][1]) ; Activate a window
			_findImageBtn("btnCont", 90, 10000)
